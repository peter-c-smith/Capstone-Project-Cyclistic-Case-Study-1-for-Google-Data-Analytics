This markdown was created from a pdf provided by Google using PDF To Markdown Converter
...
**Note:** Completing this case study within a week is a reasonable goal.
...
1. Download the trip data.
    **Note** : If you are planning on using Python, the starter script shared in a later step uses
    the Divvy 2019 Q1 and Divvy 2020 Q1 datasets.
2. Unzip the files.
3. Create a folder on your desktop or Drive to house the files. Use appropriate file-naming
    conventions.
4. Create subfolders for the .csv files or .xls files so that you have a copy of the original
    data. Move the downloaded files to the appropriate subfolder.
...
If you like, continue working with the data to better familiarize yourself with it and perhaps even
identify new approaches to answering the business questions.

## Analyze

Now that your data is stored appropriately and has been prepared for analysis, start putting it
to work. Use the following Case Study Roadmap as a guide:
...
7. Once you have spent some time working with the individual spreadsheets, merge them
    ...
    analysis, either a spreadsheet, a database and SQL, or Python.
...
3. Where relevant, use JOIN statements to combine your data into one table.
4. Create summary statistics.
5. Investigate interesting trends and save that information to a table.


**Follow these steps for using Python**
Access your Python coding environment and use this script to complete the following steps:
...
1. Take out a piece of paper and a pen and sketch some ideas for how you will visualize the
    data.
...
3. Create your data visualization, remembering that contrast should be used to draw your
    audience’s attention to the most important insights. Use artistic principles including size,
    color, and shape.
...
deliverables Moreno asked you to create, including the three top recommendations based on
...
Congratulations on finishing the Cyclistic bike-share case study! If you like, complete another
case study to continue growing your portfolio. Or, use the steps from the **Ask** , **Prepare** ,
**Process** , **Analyze** , **Share** , and **Act** Case Study Roadmap to create a new project that’s all your
own. Best of luck on your job search!
